            ...
            <div id="station-fields">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="station_code"
                           value="{{ $user->station->station_code ?? old('station_code') }}"
                           class="form-control">
                </div>

                <div class="form-group">
                    <label>Station Head Name</label>
                ...
                <div class="form-group">
                    <label>Station Head Phone</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="city"
                           value="{{ $user->station->city ?? old('city') }}"
                           class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="state"
                           value="{{ $user->station->state ?? old('state') }}"
                           class="form-control">
                </div>

                <div class="form-group">
                    <label>Address</label>
                    <textarea name="address" class="form-control">{{ $user->station->address ?? old('address') }}</textarea>
                </div>
...
{{-- ✅ Add JS directly inside this blade --}}
@section('javascript')
<script>
