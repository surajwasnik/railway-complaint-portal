...
{
    /**
     * Generate bilingual WhatsApp message based on FIR status
     *
     * @param string $status
     ...
     * @param string|null $ioContact Optional for mobile recovered
     * @return array
     */

public static function productListForCompositeProd(){
    return 'Diksha';
}
    ...
    public static function getMessage(
        ...
        switch ($status) {
            ...
            case 'Mobile Recovered':
                $english = "Dear {$complainantName},\nYour FIR No. {$firNumber}, dated {$date}, registered at {$policeStation} could not be detected despite investigation. A closure report has been filed as per legal procedure.\nFor more details, please contact {$policeStation} / {$officerName}.\n- {$officerName}";
            ...
            case 'closure':
                $english = "Dear {$complainantName},\nFIR status is unknown. Please contact {$policeStation} for details.\n- {$officerName}";
                $marathi = "आदरणीय {$complainantName},\nFIR स्थिती अज्ञात आहे. कृपया अधिक माहितीसाठी {$policeStation} येथे संपर्क साधा.\n- {$officerName}";
                break;
